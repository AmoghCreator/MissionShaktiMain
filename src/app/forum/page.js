    ...
    messages: [
      {
        ...
        message:
          'Greetings, fellow SHG members! What products are available for sale this month?',
      ...
      <div className="container mx-auto my-8 h-full flex">
        <Grid container spacing={4} className="h-full">
          ...
          <Grid item xs={12} md={6} className="flex flex-col justify-between">
            <Paper className="p-4 bg-[#f6f6f6] h-full w-full">
              ...
              <List>
                {mockThreads.map(thread => (
                  <ListItem
                    ...
                    className={`hover:bg-gray-100 my-2 rounded-md ${
                      expandedThreadId === thread.id ? 'bg-[#e8f4e9]' : ''
                    }`}
                    ...
                    {selectedThread.messages.map(message => (
                      <ListItem key={message.id}>
                        <ListItemAvatar>
                          <Avatar
                            src={
                              message.user.name.split(' ')[0] !== 'Sovan'
